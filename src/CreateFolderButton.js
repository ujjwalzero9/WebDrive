...
function CreateFolderButton({ userId, folderPath, refreshFolders }) {
  ...
  const handleCreateFolder = async () => {
    try {
      ...
      await axios.post('http://127.0.0.1:8000/api/create_entity/', payload);
      ...
      await axios.post('http://127.0.0.1:8000/api/get_entities/', payload);
